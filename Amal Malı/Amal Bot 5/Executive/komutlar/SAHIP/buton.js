...
message.channel.send(`${client.emojis.cache.find(x => x.name === "ramal_yildiz")} Hepinize merhabalar **${message.guild.name}** Sunucuya girdiğinizden itibaren <@&969971423735058462> & <@&969971340838850560> & <@&969971563313119342> rolleri üzerinize verildi! Bu rolleri kaldırmak için uygun butonlara tıklamanız yeterli olacaktır!\n
