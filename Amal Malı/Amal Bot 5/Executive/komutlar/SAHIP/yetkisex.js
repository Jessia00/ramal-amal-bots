...
module.exports.run = async (client, message, args, durum, kanal) => {
    ...
    let target = message.mentions.members.first() || message.guild.members.cache.get(args[0]);
        ...
        const yetki1 =  new disbut.MessageButton().setID("yetki1").setLabel("✩  Register").setStyle("red");
        const yetki2 =  new disbut.MessageButton().setID("yetki2").setLabel("✩  Bot commands").setStyle("red");
