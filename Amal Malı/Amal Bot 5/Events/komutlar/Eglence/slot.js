...
const symbols = [
    new SlotSymbol('1', {
        display: "<a:ramal_coin:969972572135489577>",
        points: 0.6666666666666667,
        weight: 100
    }),
    new SlotSymbol('2', {
        display: "<a:ramal_yildiz:969972568943628358>",
        points: 0.6666666666666667,
        weight: 100
    }),
    new SlotSymbol('3', {
	...
	if (sec == "all" && data.para > 0) {
		...
		.setFooter("ramalask ❤️")
		.setTimestamp()
        const dollarSigns = '   <a:ramal_slots:972410849765515264> <a:ramal_slots:972410849765515264> <a:ramal_slots:972410849765515264>   ';
