...
module.exports = {
  ...
  async execute(interaction, bot) {
    ...
    .setLabel("Sunucu")
    .setStyle("SUCCESS")
    .setEmoji('997666638054825984');

    const yetki = new MessageButton()
    .setCustomId("Yetki")
    .setLabel("Yetki")
    .setStyle("SUCCESS")
    .setEmoji('997876674492366960');

    const roles = new MessageButton()
    .setCustomId("Roles")
    .setLabel("Rol")
    .setStyle("SUCCESS")
    .setEmoji('997678706879365201');

    const channels = new MessageButton()
    .setCustomId("Channel")
    .setLabel("Kanal")
    .setStyle("SUCCESS")
    .setEmoji('997876707874844772');

    const cancel = new MessageButton()
    .setCustomId("Cancel")
    .setLabel("İşlem İptal")
    .setStyle("DANGER")
    .setEmoji('997666623626428437');
...
Sunucu
\`\`\`
Sunucu İçerisindeki Bütün Yetki Ve Rolleri Database Kayıt Yapar.
`, inline: true
        },
...
Yetki
\`\`\`
Sunucu İçerisindeki Bütün Yetkileri Database Kayıt Eder.
`, inline: true
        },
...
Rol
\`\`\`
Sunucu İçerisindeki Rolleri Database Kayıt Eder.
`, inline: true
        },
      )
...
Kanal
\`\`\`
Sunucu İçerisindeki Kanalları Database Kayıt Eder.
`, inline: true
        },
...
İptal
\`\`\`
Başlattığın Backup Alma İşlemini İptal Eder.
`, inline: true
        },
      )
