...
module.exports = {
    ...
    async execute(interaction, bot) {
      if(!Config.BotOwner.includes(interaction.user.id)) {
        ...
        .setLabel("Veri Kayıt")
        .setStyle("PRIMARY")
        .setEmoji('997678697685471262');

        const ac = new MessageButton()
        .setCustomId("aç")
        .setLabel("Koruma Aç")
        .setStyle("SUCCESS")
        .setEmoji('997855617370837002');

        const kapa = new MessageButton()
        .setCustomId("kapat")
        .setLabel("Koruma Kapat")
        .setStyle("DANGER")
        .setEmoji('997666633671782522');
...
Veri Kayıt
\`\`\`
Sunucu İçerisindeki Verileri Database Kayıt Eder.
`, inline: true
},
{
name: "\n\u200b", value: `
...
Koruma Aç
\`\`\`
Sunucudaki Bütün Yetkisi Açık Olan Kritik Bütün Rollerin Yetkisini Kapatır.
`, inline: true
},
{
name: "\n\u200b", value: `
...
Koruma Kapat
\`\`\`
Sunucu İçerisindeki Kapatılan Rollerin Tekrardan Aynı Şekilde Yetkilerini Açar.
`, inline: true
},
)
