...
exports.run = async (client, message, args, durum, kanal) => {
  ...
  if (!client.ayarlar.sahip.some(x => x === message.author.id)) return
    ...
    let onay = "https://cdn.discordapp.com/emojis/963140764370604072.gif?size=96&quality=lossless";
    let onay2 = "https://cdn.discordapp.com/emojis/802098678369091594.gif?v=1";
    ...
    let meri_hata = "https://cdn.discordapp.com/emojis/926502707404083210.gif?size=96&quality=lossless";
    ...
    guild.emojis.create(meri_hata, "meri_hata").then(emoji => message.channel.send(`Başarıyla ${emoji.name} adında emoji oluşturuldu. (${emoji})`)).catch(console.error);
