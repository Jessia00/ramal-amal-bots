...
class Names extends Command {
    ...
    async run(client, message, args, embed) {
        ...
        if (!ramal.commandsChannel.some(kanal => message.channel.id.includes(kanal)) && message.channel.id !== ramal.welcomeChannel) return message.reply(`**UYARI:** Bu komutu yalnızca <#${ramal.welcomeChannel}> kanalında kullanabilirsin!`).sil(10)
