...
class Cmute extends Command {
    ...
    async run(client, message, args, embed) {
        ...
        if (member.roles.cache.has(ramal.mutedRole)) return message.channel.send({ embeds: [embed.setDescription(`**UYARI :** BU kullanıcı zaten chatte susturulmuş!`)]}).sil(10)
        ...
        await member.roles.add(ramal.mutedRole, `Chat Susturma, Yetkili: ${message.author.id}`)
