const { Ramalcim, Inviter, Users } = require("../../../../Helpers/Schemas")
        ...
        message.reply({ embeds: [embed] }).then(async msg => {
            ...
            collector.on('collect', async (reaction, user) => {
                ...
                if (reaction.emoji.name === "▶") {
                    ...
                    currentPage--;
                    if (currentPage == 0 && msg) msg.edit({ embeds: [embed.setTitle("").setDescription(description).setFooter(`bwratxd&ramallesnar`)] });
