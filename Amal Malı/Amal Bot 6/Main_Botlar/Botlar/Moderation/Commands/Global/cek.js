...
class Cek extends Command {
    ...
    async run(client, message, args, embed) {
        ...
        if (ramal.yonetimRoles.some(x => message.member.roles.cache.has(x)) || config.root.includes(message.author.id) || message.member.roles.cache.has(ramal.moveHammer)) {
