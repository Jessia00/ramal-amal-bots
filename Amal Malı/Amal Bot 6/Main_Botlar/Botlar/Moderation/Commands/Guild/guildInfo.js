...
class GuildInfo extends Command {
    ...
    async run(client, message, args, embed) {
        ...
        let yetkili = message.guild.members.cache.filter(yetkili => yetkili.roles.cache.has(ramal?.registerHammer)).size
...
${yonetici ? yonetici.map(Ramalcims => `${Ramalcims}`).join(' , ') : "Rolde bulunan kimse yok!"}
**────────────────────────**
\`\`\`cs
[URL/SUNUCU YÖNET] yetkisine sahip olan (${urlsunucu.length}) kişilerin listesi;\`\`\`
${urlsunucu ? urlsunucu.map(Ramalcims => `${Ramalcims}`).join(' , ') : "Rolde bulunan kimse yok!"}
**────────────────────────**
\`\`\`cs
[ROL YÖNET] yetkisine sahip olan (${rolyonet.length}) kişilerin listesi;\`\`\`
${rolyonet ? rolyonet.map(Ramalcims => `${Ramalcims}`).join(' , ') : "Rolde bulunan kimse yok!"}
**────────────────────────**
\`\`\`cs
[KANAL YÖNET] yetkisine sahip olan (${kanalyonet.length}) kişilerin listesi;\`\`\`
${kanalyonet ? kanalyonet.map(Ramalcims => `${Ramalcims}`).join(' , ') : "Rolde bulunan kimse yok!"}
**────────────────────────**
                `)],
                        ephemeral: true
                    })
