...
module.exports = {
  ...
  onRequest: async function (client, message, args) {
    ...
    if(!uye) return message.channel.send(cevaplar.üye + ` \`${sistem.botSettings.Prefixs[0]}${module.exports.Isim} <@user/ID>\``);
    ...
    const sebeps = [
        { label: "Kışkırtma, Trol ve Dalgacı Davranış", description: "15 Dakika", emoji: {name: "1️⃣"} , value: "1", date: "15m", type: 5},
        { label: "Flood,Spam ve Capslock Kullanımı", description: "5 Dakika", emoji: {name: "2️⃣"} ,value: "2", date: "5m", type: 5},
        ...
        { label: "Abartı, Küfür ve Taciz Kullanımı", description: "1 Saat", emoji: {name: "7️⃣"}, value: "7", date: "1h", type: 5},
        { label: "Kışkırtma, Trol ve Dalgacı Davranış", description: "1 Saat", emoji: {name: "1️⃣"} , value: "8", date: "1h", type: 4},
        { label: "Abartı, Küfür ve Taciz Kullanımı", description: "30 Dakika", emoji: {name: "2️⃣"} ,value: "9", date: "30m", type: 4},
