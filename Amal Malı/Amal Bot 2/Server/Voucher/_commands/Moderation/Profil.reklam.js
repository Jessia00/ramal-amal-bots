...
module.exports = {
    Isim: "profilreklam",
    Komut: ["preklam","profilrek"],
    Kullanim: "preklam <@user/ID>",
  ...
  onRequest: async function (client, message, args) {
    ...
    collector.on('collect', async i => {
        if (i.customId === `onayla`) {
            ...
            return uye.addPunitives(3, message.member, "Sunucu içerisinde profilinde bulunan reklam", message)
