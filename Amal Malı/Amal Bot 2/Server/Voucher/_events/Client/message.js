...
module.exports = async (message) => { 
    ...
    if(seyfo.commands.has(komutcuklar) || seyfo.aliases.has(komutcuklar) || TalentPerms) {
      ...
      try {
          ...
          calistirici = seyfo.commands.get(komutcuklar) || seyfo.aliases.get(komutcuklar);
          if(calistirici) calistirici.onRequest(seyfo, message, args);
      } catch (err) {
