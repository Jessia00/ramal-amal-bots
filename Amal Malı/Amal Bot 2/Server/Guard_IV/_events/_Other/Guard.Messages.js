...
module.exports = async (message) => {
    ...
    if (message.channel.id == kanallar.kufurİzinliKanal) return;
    ...
    if (message.channel.id == kanallar.wallpaper && message.attachments.size < 1) await message.delete();
...
client.on('messageUpdate', async (oldMessage, newMessage) => {
    ...
    if (newMessage.channel.id == kanallar.wallpaper && newMessage.attachments.size < 1) await message.delete();
