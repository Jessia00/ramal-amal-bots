...
module.exports = async (member, role) => {
    ...
    if(logChannel) logChannel.send({embeds: [new genEmbed().setDescription(`${member} isimli üyeye **${tarihsel(Date.now())}** tarihinde ${Log.executor} tarafından ${role} adlı rol verildi.`)]})  
