...
let dcmodal = require('discord-modals')
        ...
        async queryManage(oldData, newData) {
            ...
            if(sunucuData) {              
                ...
                if(oldData === sunucuData.kufurİzinliKanal) {
                    await guildSettings.updateOne({guildID: sistem.SERVER.ID}, {$set: {"Ayarlar.kufurİzinliKanal": newData}}, {upsert: true})
                }
                ...
                if(oldData === sunucuData.wallpaper) {
                    await guildSettings.updateOne({guildID: sistem.SERVER.ID}, {$set: {"Ayarlar.wallpaper": newData}}, {upsert: true})
                }
